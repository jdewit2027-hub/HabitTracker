  ...
  var BUILTIN_THEMES = {
    ...
    'voxel-world': {
      ...
      vars: {
        ...
        '--theme-bg-overlay': 'linear-gradient(180deg,rgba(2,18,20,.38),rgba(2,20,18,.73) 58%,rgba(2,13,14,.9))',
        '--theme-texture': 'repeating-linear-gradient(0deg,transparent 0 15px,rgba(148,255,202,.025) 15px 16px),repeating-linear-gradient(90deg,transparent 0 15px,rgba(148,255,202,.025) 15px 16px)',
        '--theme-surface': '#0A3533',
        '--theme-surface-raised': '#11504A',
        '--theme-surface-transparent': 'rgba(5,45,43,.76)',
        '--theme-header': 'rgba(3,31,32,.82)',
        '--theme-input': 'rgba(1,24,25,.68)',
        '--theme-text': '#F1FFF8',
        '--theme-text-muted': '#A5CCBB',
        '--theme-accent': '#33D17A',
        '--theme-accent-secondary': '#93F7C1',
        '--theme-border': 'rgba(136,244,191,.23)',
        '--theme-border-strong': 'rgba(145,255,202,.5)',
        '--theme-shadow': '0 14px 38px rgba(0,16,16,.58),inset 0 1px 0 rgba(220,255,238,.08)',
        '--theme-glow': 'rgba(77,255,155,.72)',
        '--theme-success': '#66F0A3',
        '--theme-danger': '#FF7D6E',
        '--theme-xp-fill': 'linear-gradient(90deg,#168E67,#42E58B 55%,#9CFFD0)',
        '--theme-xp': '#78F5C0',
        '--theme-on-accent': '#032218',
        '--theme-radius': '8px',
        '--theme-radius-sm': '5px',
        '--theme-heading-font': 'Impact,"Arial Black",system-ui,sans-serif',
        '--theme-body-font': 'system-ui,-apple-system,"Segoe UI",sans-serif'
      }
    },
    'midnight': {
      name: 'Midnight',
